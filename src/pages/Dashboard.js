...
const Dashboard = () => {
  return (
    ...
    <Box sx={{ padding:6 }}>
      ...
      {/* Statistics Cards */}
      <Grid container spacing={5}justifyContent="center" sx={{ display: "flex" }}>
        {statistics.map((stat, index) => (
          <Grid item key={index}>
            <Card sx={{ backgroundColor: "#002147", color: "white", padding: 2, width: 90, textAlign: "center" }}>
              <Typography variant="h9" sx={{ fontWeight: "bold" }}>{stat.value}</Typography>
